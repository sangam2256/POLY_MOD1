...
const ABI = require("../artifacts/contracts/itzoak.sol/itzoak.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("itzoak");
  const nft = await NFT.attach("0x169419D73b3efDD2CF01bE573211a90A0E966464");
